...
$lang = array_merge($lang, array(
	...
	'BBCODE_INVALID_TAG_NAME'	=> 'Le nom de la balise BBCode que vous avez sélectionnée existe déjà.',
	...
	'BBCODE_TAG'				=> 'Balise',
	'BBCODE_TAG_TOO_LONG'		=> 'Le nom de la balise que vous avez sélectionnée est trop long.',
...
$lang = array_merge($lang, array(
	...
	'EXPORT_ICONS_EXPLAIN'		=> '%sEn cliquant sur ce lien, la configuration des icônes que vous avez installées sera regroupée dans l’ensemble <samp>icons.pak</samp> qui, une fois téléchargé, peut être utilisé afin de créer un fichier <samp>.zip</samp> ou <samp>.tgz</samp> qui contient toutes vos icônes, ainsi que le fichier de configuration <samp>icons.pak</samp>%s.',
	'EXPORT_SMILIES'			=> 'Exporter et télécharger smilies.pak',
	'EXPORT_SMILIES_EXPLAIN'	=> '%sEn cliquant sur ce lien, la configuration des émoticônes que vous avez installées sera regroupée dans l’ensemble <samp>smilies.pak</samp> qui, une fois téléchargé, peut être utilisé afin de créer un fichier <samp>.zip</samp> ou <samp>.tgz</samp> qui contient toutes vos émoticônes, ainsi que le fichier de configuration <samp>smilies.pak</samp>%s.',
	...
	'ICONS_IMPORTED'		=> 'L’ensemble d’icônes a été installé avec succès.',
	'ICONS_IMPORT_SUCCESS'	=> 'L’ensemble d’icônes a été importé avec succès.',
	...
	'IMPORT_ICONS'			=> 'Installer un ensemble d’icônes',
	'IMPORT_SMILIES'		=> 'Installer un ensemble d’émoticônes',
  ...
  'NO_ICONS_EXPORT'	=> 'Vous n’avez sélectionné aucune icône afin de créer un ensemble.',
	'NO_ICONS_PAK'		=> 'Aucun ensemble d’icônes n’a été trouvée.',
	...
	'NO_SMILIES_EXPORT'	=> 'Vous n’avez aucune émoticône afin de créer un ensemble.',
	'NO_SMILIES_PAK'	=> 'Aucun ensemble d’émoticônes n’a été trouvé.',
	...
	'SMILIE_NO_FILE'			=> 'L’émoticône « %s » a été ignorée car le fichier est absent.',
	...
	'SMILIES_IMPORTED'			=> 'L’ensemble d’émoticônes a été installé avec succès.',
	'SMILIES_IMPORT_SUCCESS'	=> 'L’ensemble d’émoticônes a été importé avec succès.',
	...
	'WRONG_PAK_TYPE'	=> 'L’archive que vous avez spécifiée ne contient pas de données appropriées.',
));
