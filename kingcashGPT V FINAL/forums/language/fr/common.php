...
$lang = array_merge($lang, array(
	...
	'ATTACHED_IMAGE_NOT_IMAGE'		=> 'L’image que vous avez tenté d’insérer est incorrecte.',
	'AUTHOR'						=> 'Auteur',
	...
	'NOT_WATCHING_FORUM'		=> 'Vous n’êtes à présent plus abonné à ce forum. Vous ne serez plus averti(e) lorsque de nouveaux sujets seront publiés dans ce dernier.',
	'NOT_WATCHING_TOPIC'		=> 'Vous n’êtes à présent plus abonné à ce sujet. Vous ne serez plus averti(e) lorsque de nouveaux messages seront publiés dans ce dernier.',
	...
	'NO_AUTH_ADMIN'				=> 'Vous n’êtes pas autorisé à accéder au panneau de contrôle d’administration.',
	'NO_AUTH_ADMIN_USER_DIFFER'	=> 'Vous n’êtes pas autorisé à vous authentifier de nouveau avec un compte utilisateur différent au vôtre.',
	...
	'POST_PCT_ACTIVE'		=> '%.2f%% du nombre total des messages de l’utilisateur',
	...
	'SEARCH_KEYWORDS'			=> 'Rechercher par mot(s)-clé(s) ',
	...
	'TOO_SMALL_MAX_RECIPIENTS'		=> 'La valeur du réglage <strong>Nombre maximum de destinataires autorisés par message privé</strong> que vous avez saisie est trop petite.',
	...
	'USER_NEW_PERMISSION_DISALLOWED'	=> 'Vous n’êtes pas autorisé à utiliser cette fonctionnalité. Pour l’être, vous devez simplement vous inscrire et participer de manière plus active.',
