...
$help = array( 
   ...
   array( 
      ...
      1 => 'Em alguns fóruns, anexar arquivos pode estar restrito a alguns usuários ou grupos. Para anexar um arquivo, você precisa de uma autorização especial. Apenas os administradores e o moderador do fórum podem lhe dar esse acesso. Por favor, contate-os para saber o motivo de você não estar autorizado a anexar arquivos.' 
   ), 
   array( 
