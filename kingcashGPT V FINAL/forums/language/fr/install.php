...
$lang = array_merge($lang, array(
	...
	'COLLIDING_USERNAMES_FOUND'	=> 'Des noms d’utilisateurs similaires ont été trouvés sur votre ancien forum. Pour accomplir correctement la conversion, vous devez supprimer ou renommer ces utilisateurs de sorte que chaque nom d’utilisateur soit unique.',
	...
	'COULD_NOT_FIND_PATH'		=> 'Le chemin vers votre ancien forum est introuvable. Veuillez vérifier vos réglages, puis réessayer.<br />» %s était spécifié comme le chemin source.',
	...
	'DB_PORT_EXPLAIN'			=> 'Laissez ceci vide excepté l’utilisation d’un port différent par le serveur.',
	...
	'ENABLE_KEYS'				=> 'Réactivation des clés. Cette opération peut prendre un certain temps.',
	...
	'FORUM_ADDRESS_EXPLAIN'		=> 'Ceci est l’ancienne adresse de votre forum, telle que <samp>http://www.example.com/phpBB2/</samp>. Si vous remplissez ce champ, tous les liens pointant vers l’ancienne adresse de votre forum insérés dans vos messages, vos messages privés et vos signatures seront mis à jour avec la nouvelle adresse de votre forum.',
	...
	'INSTALL_NEXT_PASS'			=> 'Tous les tests basiques ont été réalisés avec succès et vous pouvez à présent continuer vers l’étape suivante de l’installation. Dans le cas où vous avez modifié certains modules ou certaines permissions, sachez que vous pouvez de nouveau tester votre installation.',
	'INSTALL_PANEL'				=> 'Panneau d’installation',
	'INSTALL_SEND_CONFIG'		=> 'Malheureusement, les informations de configuration n’ont pas pu être écrites par phpBB dans votre fichier config.php. Il est possible que ce fichier n’existe pas ou qu’il ne soit pas inscriptible. Vous trouverez ci-dessous une liste d’options vous permettant d’accomplir correctement l’installation de ce fichier.',
	...
	'INST_ERR_DB_FORUM_PATH'	=> 'Le fichier de base de données que vous avez spécifié est situé dans le répertoire racine de votre forum. Vous devriez déplacer ce fichier dans un environnement hors-ligne.',
	...
	'INST_ERR_PREFIX_TOO_LONG'	=> 'Le préfixe de table que vous avez saisi est trop long. La longueur maximale est de %d caractères.',
	...
	'SUPPORT_BODY'				=> 'Un support complet et gratuit vous est offert pour la dernière version stable de phpBB3. Cela comprend :</p><ul><li>l’installation</li><li>la configuration</li><li>les questions d’ordre technique</li><li>les problèmes en relation avec des bogues potentiels dans le logiciel</li><li>la mise à jour d’une des versions Release Candidate (RC) vers la dernière version stable</li><li>la conversion de phpBB 2.0.x vers phpBB3</li><li>la conversion d’un des nombreux logiciels de forums de discussions vers phpBB3 (veuillez consulter le <a href="http://www.phpbb.com/community/viewforum.php?f=65">forum relatif aux convertisseurs</a>)</li></ul><p>Nous continuons à encourager les utilisateurs utilisant une des versions bêta de phpBB3 à remplacer celle-ci par une installation propre de la dernière version stable.</p><h2>MODs / Styles</h2><p>En ce qui concerne les problèmes relatifs aux MODs, veuillez publier vos demandes de support dans le <a href="http://www.phpbb.com/community/viewforum.php?f=81">forum relatif aux modifications</a>.<br />En ce qui concerne les problèmes relatifs aux styles, aux templates et aux ensembles d’images, veuillez publier vos demandes de support dans le <a href="http://www.phpbb.com/community/viewforum.php?f=80">forum relatif aux styles</a>.<br /><br />Si votre question est portée sur une archive spécifique, veuillez publier directement votre message dans le sujet dédié à cette archive.</p><h2>Obtention du support</h2><p><a href="http://www.phpbb.com/community/viewtopic.php?f=14&amp;t=571070">L’archive de bienvenue de phpBB</a><br /><a href="http://www.phpbb.com/support/">La section relative au support</a><br /><a href="http://www.phpbb.com/support/documentation/3.0/quickstart/">Le guide de démarrage rapide</a><br /><br />Si vous souhaitez vous assurer d’être tenu au courant des dernières nouveautés et des dernières sorties de nos logiciels, pourquoi ne pas <a href="http://www.phpbb.com/support/">vous inscrire à notre liste de diffusion</a> ?<br /><br />',
	...
	'TESTS_PASSED'				=> 'Tests passés avec succès',
...
$lang = array_merge($lang, array(
	...
	'INLINE_UPDATE_SUCCESSFUL'		=> 'La base de données a été mise à jour avec succès. Vous devez à présent continuer le processus de mise à jour.',
	...
	'NO_AUTH_UPDATE'				=> 'Vous n’êtes pas autorisé à effectuer une mise à jour',
	...
	'NO_UPDATE_FILES_OUTDATED'		=> 'Aucun répertoire de mise à jour valide n’a été trouvé, veuillez vous assurer d’avoir correctement transféré les fichiers nécessaires.<br /><br />Votre installation ne semble <strong>pas</strong> à jour. Des mises à jour sont disponibles pour votre version de phpBB %1$s, veuillez vous rendre sur <a href="http://www.phpbb.com/downloads/" rel="external">la page des téléchargements du site officiel</a> ou sur <a href="http://www.phpbb.fr/" rel="external">la communauté de support francophone</a> afin d’obtenir une archive de mise à jour de votre version %2$s vers la version %3$s.',
	...
	'TRY_DOWNLOAD_METHOD'		=> 'Vous devriez essayer la méthode de téléchargement des fichiers modifiés.<br />Cette méthode vous permettra de mettre à jour votre forum sans rencontrer de difficultés.',
	'TRY_DOWNLOAD_METHOD_BUTTON'=> 'Essayer maintenant cette méthode',

	'UPDATE_COMPLETED'				=> 'Mise à jour réalisée avec succès',
	...
	'UPDATE_INSTRUCTIONS'			=> '
		...
		<ul style="margin-left: 20px; font-size: 1.1em;">
			<li>Rendez-vous sur <a href="http://www.phpbb.com/downloads/" title="http://www.phpbb.com/downloads/">la page des téléchargements du site officiel</a> ou sur <a href="http://www.phpbb.fr/" title="http://www.phpbb.fr/">la communauté de support francophone</a> et téléchargez l’archive de mise à jour automatique.<br /><br /></li>
		...
		<br />
		Vous serez alors guidé par le processus de mise à jour, qui vous avertira une fois la mise à jour terminée.
		</p>
	',
	...
	'UPDATE_SUCCESS_EXPLAIN'		=> 'Tous les fichiers ont été mis à jour avec succès. La prochaine étape consiste à vérifier de nouveau tous les répertoires afin de vous assurer que les fichiers ont été mis à jour correctement.',
	...
	'VERSION_CHECK_EXPLAIN'			=> 'Vérifir si votre installation de phpBB est à jour.',
...
$lang = array_merge($lang, array(
	...
	'REPORT_OTHER'					=> 'Le message rapporté ne correspond à aucune catégorie, veuillez utiliser le champ d’information supplémentaire.',
