...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_EMAIL_CHANGED'			=> 'Votre compte a été mis à jour avec succès. Cependant, vous devez le réactiver car vous avez modifié votre adresse de courrier électronique. Une clé d’activation a été envoyée sur la nouvelle adresse de courrier électronique que vous avez saisie. Veuillez consulter votre messagerie pour plus d’informations.',
	'ACCOUNT_EMAIL_CHANGED_ADMIN'	=> 'Votre compte a été mis à jour avec succès. Cependant, un des administrateurs doit le réactiver car vous avez modifié votre adresse de courrier électronique. Un courriel leur a été envoyé et vous serez informé de la réactivation de votre compte.',
	'ACCOUNT_INACTIVE'				=> 'Votre compte a été créé avec succès. Cependant, vous devez activer votre compte. Une clé d’activation a été envoyée sur l’adresse de courrier électronique que vous avez saisie. Veuillez consulter votre messagerie pour plus d’informations.',
	'ACCOUNT_INACTIVE_ADMIN'		=> 'Votre compte a été créé avec succès. Cependant, un des administrateurs doit activer votre compte. Un courriel leur a été envoyé et vous serez informé de la réactivation de votre compte.',
	...
	'BOOKMARKS_REMOVED'			=> 'Vos signets ont été supprimés avec succès.',
	...
	'CONFIRM_EXPLAIN'			=> 'Pour empêcher les inscriptions automatisées, vous devez saisir un code de confirmation. Le code est affiché dans l’image que vous devriez voir ci-dessous. Si vous êtes visuellement déficient ou que vous éprouvez des difficultés à lire ce code correctement, veuillez contacter l’%sadministrateur du forum%s.',
	...
	'CONFIRM_PASSWORD_EXPLAIN'	=> 'Vous ne devez confirmer votre mot de passe que si avez modifié ce dernier ci-dessus.',
	...
	'CURRENT_PASSWORD_EXPLAIN'	=> 'Vous devez confirmer votre mot de passe actuel si vous souhaitez modifier votre mot de passe, votre adresse de courrier électronique ou votre nom d’utilisateur.',
	...
	'DOMAIN_NO_MX_RECORD_EMAIL'	=> 'Le domaine de l’adresse de courrier électronique que vous avez saisie ne contient aucun enregistrement MX valide.',
	'DOWNLOADS'					=> 'Téléchargements',
	'DRAFTS_DELETED'			=> 'Tous les brouillons que vous avez sélectionnés ont été supprimés avec succès.',
	...
	'EMAIL_INVALID_EMAIL'		=> 'L’adresse de courrier électronique que vous avez saisie n’est pas valide.',
	...
	'FIELD_TOO_SHORT'					=> 'Le champ « %1$s » est trop court, vous devez saisir plus de %2$d caractères.',
	'FIELD_TOO_LONG'					=> 'Le champ « %1$s » est trop long, vous devez saisir moins de %2$d caractères.',
	'FIELD_TOO_SMALL'					=> 'La valeur de « %1$s » est trop faible, vous devez spécifier plus de %2$d.',
	'FIELD_TOO_LARGE'					=> 'La valeur de « %1$s » est trop importante, vous devez spécifier moins de %2$d.',
	...
	'FIELD_INVALID_CHARS_SPACERS_ONLY'	=> 'Le champ « %s » contient des caractères invalides, seuls les caractères alphanumériques, les espaces ou les signes -+_[] sont autorisés.',
	'FIELD_INVALID_DATE'				=> 'La date que vous avez spécifiée dans le champ « %s » est invalide.',
	...
	'FOLDER_STATUS_MSG'			=> 'Le dossier est plein à %1$d%% (%2$d message(s) archivé(s) sur %3$d)',
	...
	'FULL_FOLDER_OPTION_CHANGED'=> 'L’action à entreprendre lorsqu’un dossier est plein a été modifiée avec succès.',
	...
	'INVALID_USER_BIRTHDAY'			=> 'La date d’anniversaire que vous avez spécifiée n’est pas une date valide.',
	...
	'NO_AUTH_FORWARD_MESSAGE'		=> 'Vous n’êtes pas autorisé à transférer des messages privés.',
	...
	'NO_AUTH_READ_HOLD_MESSAGE'		=> 'Vous n’êtes pas autorisé à lire les messages privés qui sont en liste d’attente.',
	...
	'PERMISSIONS_RESTORED'		=> 'Les permissions par défaut ont été restaurées avec succès.',
	'PERMISSIONS_TRANSFERRED'	=> 'Les permissions de <strong>%s</strong> ont été transférées avec succès, vous pouvez à présent parcourir le forum avec les permissions de cet utilisateur.<br />Veuillez noter que les permissions d’administration ne seront pas transférées. Vous pouvez restaurer vos permissions à tout moment.',
	...
	'REMOVE_SELECTED_BOOKMARKS_CONFIRM'	=> 'Êtes-vous sûr de vouloir supprimer tous les signets que vous avez sélectionnés ?',
	...
	'SENT_AT'					=> 'Envoyé le ',			// Used before dates in private messages
	...
	'UCP_ADMIN_ACTIVATE'		=> 'Veuillez noter que vous devez saisir une adresse de courrier électronique valide afin que votre compte soit activé. L’administrateur vérifiera votre compte et s’il est approuvé, vous recevrez un courriel à l’adresse de courrier électronique que vous avez spécifiée.',
	'UCP_AIM'					=> 'AOL Instant Messenger ',
	'UCP_ATTACHMENTS'			=> 'Pièces jointes',
	'UCP_COPPA_BEFORE'			=> 'Avant le %s',
	'UCP_COPPA_ON_AFTER'		=> 'Le ou après le %s',
	'UCP_EMAIL_ACTIVATE'		=> 'Veuillez noter que vous devez saisir une adresse de courrier électronique valide afin que votre compte soit activé. Vous recevrez un courriel qui contiendra le lien d’activation à l’adresse de courrier électronique que vous avez spécifiée.',
	'UCP_ICQ'					=> 'Numéro ICQ ',
	...
	'USERNAME_ALPHA_SPACERS_EXPLAIN'=> 'Le nom d’utilisateur doit être compris entre %1$d et %2$d caractères de long et doit contenir des caractères alphanumériques, des espaces ou des caractères que sont -, +, _, [, et ].',
	...
	'USERNAME_LETTER_NUM_SPACERS_EXPLAIN'=> 'Le nom d’utilisateur doit être compris entre %1$d et %2$d caractères de long et doit contenir des lettres, des nombres, des espaces ou des caractères que sont -, +, _, [, et ].',
	...
	'WATCHED_EXPLAIN'			=> 'La liste ci-dessous vous informe sur les forums et les sujets auxquels vous êtes abonné. Vous serez averti lorsque de nouveaux messages seront publiés dans ces derniers. Pour vous désabonner, sélectionnez le forum ou le sujet souhaité, puis cliquez sur le bouton <em>Ne plus surveiller la sélection</em>.',
	'WATCHED_FORUMS'			=> 'Forums surveillés',
	'WATCHED_TOPICS'			=> 'Sujets surveillés',
	'WRONG_ACTIVATION'			=> 'La clé d’activation que vous avez spécifiée n’est pas valide car elle est inconnue de la base de données.',
	...
	'GROUPS_EXPLAIN'	=> 'Les groupes d’utilisateurs permettent aux administrateurs de mieux administrer les utilisateurs. Par défaut, vous serez placé dans un groupe d’utilisateurs spécifique qui correspond à votre groupe par défaut. Ce groupe défini comment vous apparaîtrez aux autres utilisateurs, grâce à, par exemple, une colorisation de votre nom d’utilisateur, une utilisation d’un avatar ou d’un rang spécifique, etc. Selon la politique de l’administrateur, vous pouvez être autorisé à modifier votre groupe par défaut. Vous pouvez également être membre d’autres groupes d’utilisateurs et être autorisé à en rejoindre de nouveaux. Certains groupes d’utilisateurs peuvent vous procurer des permissions supplémentaires afin de consulter un contenu exclusif ou augmenter vos fonctionnalités dans d’autres domaines.',
