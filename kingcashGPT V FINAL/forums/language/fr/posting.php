...
$lang = array_merge($lang, array(
	...
	'CANNOT_POST_ANNOUNCE'		=> 'Vous n’êtes pas autorisé à publier des annonces.',
	'CANNOT_POST_STICKY'		=> 'Vous n’êtes pas autorisé à publier des notes.',
	...
	'DELETE_OWN_POSTS'			=> 'Vous n’êtes autorisé à supprimer que vos propres messages.',
	...
	'POLL_MAX_OPTIONS_EXPLAIN'	=> 'Ceci est le nombre d’option(s) que chaque utilisateur peut sélectionner lors de leur vote.',
	...
	'POLL_OPTIONS_EDIT_EXPLAIN'	=> 'Insérez chaque option sur une nouvelle ligne. Vous pouvez sélectionner jusqu’à <strong>%d</strong> options. Si vous supprimez ou ajoutez une ou plusieurs options, tous les votes ayant été effectués seront réinitialisés.',
	...
	'POLL_VOTE_CHANGE_EXPLAIN'	=> 'Si cette option est activée, les utilisateurs pourront modifier leur(s) vote(s).',
	...
	'POST_CONFIRM_EXPLAIN'		=> 'Pour éviter la publication de messages automatisés, vous devez saisir un code de confirmation. Le code est affiché dans l’image que vous devriez voir ci-dessous. Si vous êtes visuellement déficient ou que vous éprouvez des difficultés à lire ce code correctement, veuillez contacter l’%sadministrateur du forum%s.',
	...
	'USER_CANNOT_FORUM_POST'	=> 'Vous n’êtes pas autorisé à publier des messages dans ce type de forum.',
