...
$lang = array_merge($lang, array(
	...
	'GROUP_COLOR_EXPLAIN'			=> 'La couleur dans laquelle les noms d’utilisateurs des membres apparaîtront. Laissez cela vide afin de conserver la couleur des membres par défaut.',
	...
	'GROUP_FOUNDER_MANAGE_EXPLAIN'	=> 'Limite la gestion de ce groupe aux fondateurs uniquement. Les membres du groupe et les utilisateurs détenant les permissions de ce groupe peuvent voir ce groupe.',
	...
	'GROUP_MESSAGE_LIMIT'			=> 'Limite des messages privés par dossier des membres du groupe ',
	'GROUP_MESSAGE_LIMIT_EXPLAIN'	=> 'Ce réglage écrasera la limite des messages privés par dossier des utilisateurs. Réglez cette valeur sur 0 afin d’utiliser la limite des messages privés par dossier des utilisateurs.',
  ...
  'GROUP_MAX_RECIPIENTS_EXPLAIN'   => 'Le nombre maximum de destinataires autorisés dans un message privé. Réglez cette valeur sur 0 afin d’utiliser le réglage de la largeur du forum.',
  'GROUP_OPTIONS_SAVE'			=> 'Options larges de groupe',
	...
	'GROUP_SKIP_AUTH_EXPLAIN'		=> 'Si cette option est activée, le responsable de ce groupe n’héritera plus de ses permissions.',
	'GROUP_TYPE'					=> 'Type de groupe ',
	'GROUP_TYPE_EXPLAIN'			=> 'Détermine quels sont les utilisateurs qui peuvent rejoindre ou voir ce groupe.',
