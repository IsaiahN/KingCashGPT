...
$lang = array_merge($lang, array(
	...
	'AUTO_PRUNE_DAYS_EXPLAIN'	=> 'Nombre de jours entre la publication du dernier message d’un sujet et la suppression du sujet.',
	...
	'AUTO_PRUNE_VIEWED'			=> 'Durée du délestage automatique des messages consultés ',
  ...
  'COPY_PERMISSIONS_EXPLAIN'		=> 'Pour faciliter la configuration des permissions de votre nouveau forum, vous pouvez copier les permissions d’un forum déjà existant.',
	'COPY_PERMISSIONS_ADD_EXPLAIN'	=> 'Une fois créé, le forum détiendra les mêmes permissions que celles que vous avez sélectionnées ici. Si aucun forum n’est sélectionné, le forum créé ne sera pas visible car il ne détiendra aucune permission.',
	'COPY_PERMISSIONS_EDIT_EXPLAIN'	=> 'Si vous copiez des permissions, le forum détiendra les mêmes permissions que celles du forum que vous avez sélectionné ici. Cela écrasera toutes les permissions antérieurement définies pour ce forum. Si aucun forum n’est sélectionné, les permissions actuelles sont conservées.',
	...
	'DISPLAY_ACTIVE_TOPICS_EXPLAIN'		=> 'Si cette option est activée, les sujets actifs du sous-forum que vous avez sélectionné seront affichés dans cette catégorie.',

	'EDIT_FORUM'					=> 'Éditer le forum',
	'ENABLE_INDEXING'				=> 'Activer l’indexation de la recherche ',
	'ENABLE_INDEXING_EXPLAIN'		=> 'Si cette option est activée, les messages publiés dans ce forum seront indexés afin qu’ils puissent être recherchés.',
	'ENABLE_POST_REVIEW'			=> 'Activer la revue des messages ',
	'ENABLE_POST_REVIEW_EXPLAIN'	=> 'Si cette option est activée, les utilisateurs pourront revoir leur message en éditant celui-ci même si des réponses ont été publiées. Il est conseillé de ne pas activer cela sur des forums de discussions.',
	'ENABLE_QUICK_REPLY'			=> 'Activer la réponse rapide ',
	'ENABLE_QUICK_REPLY_EXPLAIN'	=> 'Active la réponse rapide dans ce forum. Ce réglage n’est pas pris en compte si la réponse rapide a été désactivée sur tout le forum. La réponse rapide ne sera affichée qu’aux utilisateurs autorisés à publier dans ce forum.',
	'ENABLE_RECENT'					=> 'Afficher les sujets actifs ',
	'ENABLE_RECENT_EXPLAIN'			=> 'Si cette option est activée, les sujets actifs de ce forum seront affichés dans la liste des sujets actifs.',
	...
	'FORUM_AUTO_PRUNE_EXPLAIN'			=> 'Les sujets de ce forum seront automatiquement supprimés par rapport aux réglages de la fréquence et de la durée qui sont spécifiés ci-dessous.',
	...
	'FORUM_LINK_EXPLAIN'				=> 'Lien complet, incluant le protocole <samp>http://</samp>, qui redirigera les utilisateurs vers la destination spécifiée, tel que <samp>http://www.phpbb.fr/</samp>.',
	'FORUM_LINK_TRACK'					=> 'Afficher le nombre de redirections ',
	'FORUM_LINK_TRACK_EXPLAIN'			=> 'Enregistre et affiche le nombre de visites effectués sur le lien.',
	...
	'FORUM_RULES_LINK_EXPLAIN'			=> 'Vous pouvez saisir ici le lien de la page ou du message contenant les règles de votre forum. Ce réglage écrasera les règles du forum existantes si elles ont été spécifiées.',
	...
	'FORUM_TOPICS_PAGE_EXPLAIN'			=> 'Si cette valeur est autre que 0, elle remplacera le réglage par défaut du nombre de sujets par page.',
	...
	'LINK'						=> 'Lien',
	'LIST_INDEX'				=> 'Lister les sous-forum dans la légende du forum parent ',
	'LIST_INDEX_EXPLAIN'		=> 'Affiche les sous-forums de ce forum sur l’index et sur quelques autres endroits comme lien dans la légende de son forum parent si l’option « Lister les sous-forums dans la légende » est activée.',
	'LIST_SUBFORUMS'			=> 'Lister les sous-forums dans la légende ',
	'LIST_SUBFORUMS_EXPLAIN'	=> 'Affiche les sous-forums de ce forum sur l’index et sur quelques autres endroits comme lien dans la légende de son forum parent si l’option « Lister les sous-forum dans la légende du forum parent » est activée.',
	'LOCKED'					=> 'Verrouillé',
	...
	'PRUNE_OLD_POLLS'			=> 'Délester les sondages inactifs ',
	'PRUNE_OLD_POLLS_EXPLAIN'	=> 'Supprime les sujets contenant des sondages n’ayant obtenu aucun vote durant ce nombre de jours.',
