...
$cryptwidth  = 65;  // Largeur du cryptogramme (en pixels)
$cryptheight = 20;   // Hauteur du cryptogramme (en pixels)

$bgR  = 245;         // Couleur du fond au format RGB: Red (0->255)
$bgG  = 245;         // Couleur du fond au format RGB: Green (0->255)
$bgB  = 245;         // Couleur du fond au format RGB: Blue (0->255)
...
$charR = 110;     // Couleur des caractères au format RGB: Red (0->255)
$charG = 110;     // Couleur des caractères au format RGB: Green (0->255)
$charB = 110;     // Couleur des caractères au format RGB: Blue (0->255)
...
$charspace = 8;        // Espace entre les caracteres (en pixels)
$charsizemin = 8;      // Taille minimum des caractères
$charsizemax = 8;      // Taille maximum des caractères
