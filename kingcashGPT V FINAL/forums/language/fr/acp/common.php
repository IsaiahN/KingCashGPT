...
$lang = array_merge($lang, array(
  ...
  'ADM_LOGOUT'			=> 'Déconnexion&nbsp;du&nbsp;PCA',
	...
	'NO_EMAILS_DEFINED'		=> 'Aucune adresse de courrier électronique valide n’a été trouvée.',
	...
	'SETTING_TOO_LOW'		=> 'La valeur que vous avez fournie concernant le réglage « %1$s » est trop faible. La valeur minimale acceptée est de %2$d.',
	'SETTING_TOO_BIG'		=> 'La valeur que vous avez fournie concernant le réglage « %1$s » est trop élevée. La valeur maximale acceptée est de %2$d.',	
	'SETTING_TOO_LONG'		=> 'La valeur que vous avez fournie concernant le réglage « %1$s » est trop longue. La longueur maximale acceptée est de %2$d.',
	'SETTING_TOO_SHORT'		=> 'La valeur que vous avez fournie concernant le réglage « %1$s » est trop courte. La longueur minimale acceptée est de %2$d.',
...
$lang = array_merge($lang, array(
	...
	'ACP_CRITICAL_LOGS_EXPLAIN'	=> 'Ceci liste toutes les actions qui ont été effectuées par le forum lui-même. Cet historique vous informe des problèmes qui se sont produits, comme des courriels qui n’ont pas été correctement transférés. Vous pouvez les classer par nom d’utilisateur, date, IP ou action. Si vous avez les permissions appropriées, vous pouvez également effacer les opérations une à une ou effacer entièrement l’historique.',
...
$lang = array_merge($lang, array(
	...
	'FILES_PER_DAY'		=> 'Moyenne de pièce(s) jointe(s) par jour ',
	'FORUM_STATS'		=> 'Statistiques du forum',

	'GZIP_COMPRESSION'	=> 'Compression GZip ',

	'NOT_AVAILABLE'		=> 'Indisponible',
	'NUMBER_FILES'		=> 'Nombre de pièce(s) jointe(s) ',
	'NUMBER_POSTS'		=> 'Nombre de message(s) ',
	'NUMBER_TOPICS'		=> 'Nombre de sujet(s) ',
	'NUMBER_USERS'		=> 'Nombre d’utilisateur(s) ',
	'NUMBER_ORPHAN'		=> 'Nombre de pièce(s) jointe(s) orpheline(s) ',
	...
	'USERS_PER_DAY'		=> 'Moyenne d’utilisateur(s) par jour ',
...
$lang = array_merge($lang, array(
	...
	'INACTIVE_USERS_EXPLAIN_INDEX'	=> 'Ceci est la liste des 10 derniers utilisateurs inscrits mais dont le compte est actuellement inactif. Une liste complète est disponible depuis le menu approprié ou en cliquant sur le lien ci-dessous d’où vous pourrez activer, supprimer ou rappeler ces utilisateurs en leur envoyant un courriel.',
...
$lang = array_merge($lang, array(
	...
	'LOG_ADMIN_AUTH_FAIL'		=> '<strong>Tentative de connexion au panneau de contrôle d’administration</strong>',
	...
	'LOG_BAN_EXCLUDE_USER'	=> '<strong>Exclusion d’un nom d’utilisateur du bannissement</strong> avec la raison « <em>%1$s</em> »<br />» %2$s',
	'LOG_BAN_EXCLUDE_IP'	=> '<strong>Exclusion d’une adresse IP du bannissement</strong> avec la raison « <em>%1$s</em> »<br />» %2$s',
	'LOG_BAN_EXCLUDE_EMAIL' => '<strong>Exclusion d’une adresse de courrier électronique du bannissement</strong> avec la raison « <em>%1$s</em> »<br />» %2$s',
	'LOG_BAN_USER'			=> '<strong>Bannissement d’un nom d’utilisateur</strong> avec la raison « <em>%1$s</em> »<br />» %2$s',
	'LOG_BAN_IP'			=> '<strong>Bannissement d’une adresse IP</strong> avec la raison « <em>%1$s</em> »<br />» %2$s',
	'LOG_BAN_EMAIL'			=> '<strong>Bannissement d’une adresse de courrier électronique</strong> avec la raison « <em>%1$s</em> »<br />» %2$s',
	'LOG_UNBAN_USER'		=> '<strong>Suppression d’un nom d’utilisateur du bannissement</strong><br />» %s',
	'LOG_UNBAN_IP'			=> '<strong>Suppression d’une adresse IP du bannissement</strong><br />» %s',
	'LOG_UNBAN_EMAIL'		=> '<strong>Suppression d’une adresse de courrier électronique du bannissement</strong><br />» %s',
	...
	'LOG_IMAGESET_LANG_MISSING'		=> '<strong>Traduction « %2$s » manquante d’un ensemble d’images</strong><br />» %1$s',
	...
	'LOG_TEMPLATE_ADD_DB'			=> '<strong>Ajout d’un nouvel ensemble de templates dans la base de données</strong><br />» %s',
	'LOG_TEMPLATE_ADD_FS'			=> '<strong>Ajout d’un nouvel ensemble de templates dans le système de fichiers</strong><br />» %s',
	...
	'LOG_TEMPLATE_EDIT'				=> '<strong>Édition de l’ensemble de templates <em>%1$s</em></strong><br />» %2$s',
	...
	'LOG_UPDATE_DATABASE'	=> '<strong>Mise à jour de la version %1$s de la base de données vers la version %2$s</strong>',
	'LOG_UPDATE_PHPBB'		=> '<strong>Mise à jour de la version %1$s de phpBB vers la version %2$s</strong>',
	...
	'LOG_USER_BAN_IP'		=> '<strong>Bannissement d’une adresse IP via la gestion des utilisateurs</strong> avec la raison « <em>%1$s</em> »<br />» %2$s',
	'LOG_USER_BAN_EMAIL'	=> '<strong>Bannissement d’une adresse de courrier électronique via la gestion des utilisateurs</strong> avec la raison « <em>%1$s</em> »<br />» %2$s',
	...
	'LOG_USER_UPDATE_EMAIL'	=> '<strong>Modification de l’adresse de courrier électronique de l’utilisateur « %1$s »</strong><br />» de « %2$s » vers « %3$s »',
