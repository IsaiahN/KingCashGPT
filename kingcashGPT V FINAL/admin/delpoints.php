<?php
if($_GET['do']=="delpoints")
{
print"<table width=90%><tr><th>Removing Points</th></tr><tr><td>";
if($_GET['user'] !=""){
if($_POST['value'] ==""){
print"Please Enter Amount of Points You Wish To Remove<br><a 
href='?do=delpoints'>Back</a>";
print"</td></tr></table>";
include"side.php";
include"footer.php";
exit;
...
if($_POST['username']=="")
{
print"<form action=?do=delpoints method=post>Search For Username: <input type=text 
...
print"<form action=?do=delpoints&user=".$_POST['username']." method=post><br>How 
much do you want to remove from ".$_POST['username']."?<br><input type=text name=value><br><input 
type=submit class=button value=\"Remove Points\"></form>";
}
}
print"</td></tr></table>";
} else {
